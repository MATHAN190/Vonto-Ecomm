    ...
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
        {Category_product.map((cat) => (
          ...
          <div
            key={cat.id}
            className="border rounded-lg shadow-md p-4 text-center hover:shadow-xl cursor-pointer"
          >
            <img src={cat.img} alt={cat.name} className="w-30 h-30 mx-auto mb-3 rounded-b-xl object-contain" />
